    ...
    return (
      <div className="border">
        <p>
          ...
          подключением и использованием новых библиотек
        </p>
        <p>В процессе работы вы потренируете</p>
        <p>
          использование сторонних (и своих) библиотек работу с клиентским
          роутингом в React Нужно сделать приложение для учета расходов: На
        ...
        <ul>
          ...
          <li>категорий и под-категорий приложение поддерживает ввод данных</li>
          <li>
            приложение поддерживает просмотр статистики приложение хранит данных
            отдельно для каждого пользователя
          </li>
          <li>покрытие кода от 60% приложение</li>
          <li>доступно для просмотра и проверки на github pages</li>
          <li>
            Задание не проверяется при не соответствии базовым требованиям к
            заданию
          </li>
        </ul>
      </div>
