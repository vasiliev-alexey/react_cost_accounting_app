    ...
    return (
      <div className="border">
        ...
        <p>
          <ul>
            <li>
              приложение поддерживает авторизацию приложение поддерживает
              создание
            </li>
            <li>
            ...
            <li>
              приложение поддерживает просмотр статистики приложение хранит
              данных отдельно для каждого пользователя
            </li>
